...
export default function SocialLinks({ instagram, twitter, linkedin, email }: SocialLinksProps) {
  const links = [
    { name: 'Instagram', url: instagram, icon: InstagramIcon },
    { name: 'X (Twitter)', url: twitter, icon: TwitterIcon },
    { name: 'LinkedIn', url: linkedin, icon: LinkedInIcon },
    { name: 'Email', url: email, icon: EmailIcon },
